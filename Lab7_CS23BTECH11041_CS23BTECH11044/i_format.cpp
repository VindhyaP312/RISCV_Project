...
int I_execute(vector<string> part){
    ...
    */
        ...
        // if cache is enabled
        if(isCacheEnabled){    
            mem_value_hex = getDataFromCache(addr, 1);
            if(mem_value_hex == "") return 1;
        }
        ...
        // if cache is enabled
        if(isCacheEnabled){    
            mem_value_hex = getDataFromCache(addr, 2);
            if(mem_value_hex == "") return 1;
        }
        // if cache is disabled
        else{
        ...
        // if cache is enabled
        if(isCacheEnabled){    
            mem_value_hex = getDataFromCache(addr, 4);
            if(mem_value_hex == "") return 1;
        }
        // if cache is disabled
        else{
        ...
        // if cache is enabled
        if(isCacheEnabled){    
            mem_value_hex = getDataFromCache(addr, 8);
            if(mem_value_hex == "") return 1;
        }
        // if cache is disabled
        else{
